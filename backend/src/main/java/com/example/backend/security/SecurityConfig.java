    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/pp/bom/**")
                        .hasAnyAuthority("PERMISSAO_pp:bom:read")
                        .requestMatchers(HttpMethod.POST, "/pp/bom/**")
                        .hasAnyAuthority("PERMISSAO_pp:bom:create")
                        .requestMatchers(HttpMethod.PUT, "/pp/bom/**")
                        .hasAnyAuthority("PERMISSAO_pp:bom:update")
                        .requestMatchers(HttpMethod.DELETE, "/pp/bom/**")
                        .hasAnyAuthority("PERMISSAO_pp:bom:delete")

                        .requestMatchers(HttpMethod.GET, "/pp/ordemProducao/**")
                        .hasAnyAuthority("PERMISSAO_pp:ordemProducao:read")
                        .requestMatchers(HttpMethod.POST, "/pp/ordemProducao/**")
                        .hasAnyAuthority("PERMISSAO_pp:ordemProducao:create")
                        .requestMatchers(HttpMethod.PUT, "/pp/ordemProducao/**")
                        .hasAnyAuthority("PERMISSAO_pp:ordemProducao:update")
                        .requestMatchers(HttpMethod.DELETE, "/pp/ordemProducao/**")
                        .hasAnyAuthority("PERMISSAO_pp:ordemProducao:delete")

                        .requestMatchers(HttpMethod.GET, "/pp/apontamentos/**")
                        .hasAnyAuthority("PERMISSAO_pp:apontamentos:read")
                        .requestMatchers(HttpMethod.POST, "/pp/apontamentos/**")
                        .hasAnyAuthority("PERMISSAO_pp:apontamentos:create")
                        .requestMatchers(HttpMethod.PUT, "/pp/apontamentos/**")
                        .hasAnyAuthority("PERMISSAO_pp:apontamentos:update")
                        .requestMatchers(HttpMethod.DELETE, "/pp/apontamentos/**")
                        .hasAnyAuthority("PERMISSAO_pp:apontamentos:delete")

                        .requestMatchers(HttpMethod.GET, "/pp/mrp/**")
                        .hasAnyAuthority("PERMISSAO_pp:mrp:read")
                        .requestMatchers(HttpMethod.POST, "/pp/mrp/**")
                        .hasAnyAuthority("PERMISSAO_pp:mrp:create")
                        .requestMatchers(HttpMethod.PUT, "/pp/mrp/**")
                        .hasAnyAuthority("PERMISSAO_pp:mrp:update")
                        .requestMatchers(HttpMethod.DELETE, "/pp/mrp/**")
                        .hasAnyAuthority("PERMISSAO_pp:mrp:delete")
