    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/sm/ordensServico/**")
                        .hasAnyAuthority("PERMISSAO_sm:ordensServico:read")
                        .requestMatchers(HttpMethod.POST, "/sm/ordensServico/**")
                        .hasAnyAuthority("PERMISSAO_sm:ordensServico:create")
                        .requestMatchers(HttpMethod.PUT, "/sm/ordensServico/**")
                        .hasAnyAuthority("PERMISSAO_sm:ordensServico:update")
                        .requestMatchers(HttpMethod.DELETE, "/sm/ordensServico/**")
                        .hasAnyAuthority("PERMISSAO_sm:ordensServico:delete")

                        .requestMatchers(HttpMethod.GET, "/sm/atendimentos/**")
                        .hasAnyAuthority("PERMISSAO_sm:atendimentos:read")
                        .requestMatchers(HttpMethod.POST, "/sm/atendimentos/**")
                        .hasAnyAuthority("PERMISSAO_sm:atendimentos:create")
                        .requestMatchers(HttpMethod.PUT, "/sm/atendimentos/**")
                        .hasAnyAuthority("PERMISSAO_sm:atendimentos:update")
                        .requestMatchers(HttpMethod.DELETE, "/sm/atendimentos/**")
                        .hasAnyAuthority("PERMISSAO_sm:atendimentos:delete")

                        .requestMatchers(HttpMethod.GET, "/sm/slaConfig/**")
                        .hasAnyAuthority("PERMISSAO_sm:slaConfig:read")
                        .requestMatchers(HttpMethod.POST, "/sm/slaConfig/**")
                        .hasAnyAuthority("PERMISSAO_sm:slaConfig:create")
                        .requestMatchers(HttpMethod.PUT, "/sm/slaConfig/**")
                        .hasAnyAuthority("PERMISSAO_sm:slaConfig:update")
                        .requestMatchers(HttpMethod.DELETE, "/sm/slaConfig/**")
                        .hasAnyAuthority("PERMISSAO_sm:slaConfig:delete")

                        .requestMatchers(HttpMethod.GET, "/qm/inspecoes/**")
                        .hasAnyAuthority("PERMISSAO_qm:inspecoes:read")
                        .requestMatchers(HttpMethod.POST, "/qm/inspecoes/**")
                        .hasAnyAuthority("PERMISSAO_qm:inspecoes:create")
                        .requestMatchers(HttpMethod.PUT, "/qm/inspecoes/**")
                        .hasAnyAuthority("PERMISSAO_qm:inspecoes:update")
                        .requestMatchers(HttpMethod.DELETE, "/qm/inspecoes/**")
                        .hasAnyAuthority("PERMISSAO_qm:inspecoes:delete")

                        .requestMatchers(HttpMethod.GET, "/qm/naoConformidade/**")
                        .hasAnyAuthority("PERMISSAO_qm:naoConformidade:read")
                        .requestMatchers(HttpMethod.POST, "/qm/naoConformidade/**")
                        .hasAnyAuthority("PERMISSAO_qm:naoConformidade:create")
                        .requestMatchers(HttpMethod.PUT, "/qm/naoConformidade/**")
                        .hasAnyAuthority("PERMISSAO_qm:naoConformidade:update")
                        .requestMatchers(HttpMethod.DELETE, "/qm/naoConformidade/**")
                        .hasAnyAuthority("PERMISSAO_qm:naoConformidade:delete")

                        .requestMatchers(HttpMethod.GET, "/ps/projetos/**")
                        .hasAnyAuthority("PERMISSAO_ps:projetos:read")
                        .requestMatchers(HttpMethod.POST, "/ps/projetos/**")
                        .hasAnyAuthority("PERMISSAO_ps:projetos:create")
                        .requestMatchers(HttpMethod.PUT, "/ps/projetos/**")
                        .hasAnyAuthority("PERMISSAO_ps:projetos:update")
                        .requestMatchers(HttpMethod.DELETE, "/ps/projetos/**")
                        .hasAnyAuthority("PERMISSAO_ps:projetos:delete")

                        .requestMatchers(HttpMethod.GET, "/ps/tarefas/**")
                        .hasAnyAuthority("PERMISSAO_ps:tarefas:read")
                        .requestMatchers(HttpMethod.POST, "/ps/tarefas/**")
                        .hasAnyAuthority("PERMISSAO_ps:tarefas:create")
                        .requestMatchers(HttpMethod.PUT, "/ps/tarefas/**")
                        .hasAnyAuthority("PERMISSAO_ps:tarefas:update")
                        .requestMatchers(HttpMethod.DELETE, "/ps/tarefas/**")
                        .hasAnyAuthority("PERMISSAO_ps:tarefas:delete")

                        .requestMatchers(HttpMethod.GET, "/ps/recursosAlocados/**")
                        .hasAnyAuthority("PERMISSAO_ps:recursosAlocados:read")
                        .requestMatchers(HttpMethod.POST, "/ps/recursosAlocados/**")
                        .hasAnyAuthority("PERMISSAO_ps:recursosAlocados:create")
                        .requestMatchers(HttpMethod.PUT, "/ps/recursosAlocados/**")
                        .hasAnyAuthority("PERMISSAO_ps:recursosAlocados:update")
