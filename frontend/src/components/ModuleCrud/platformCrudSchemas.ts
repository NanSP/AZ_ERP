...
const platformCrudSchemas: Record<string, CrudFormSchema> = {
  ...
  "grc.relatoriosImpacto": {
    fields: [
      { name: "titulo", label: "Titulo", type: "text", required: true },
      {
        name: "escopoCritico",
        label: "Escopo critico",
        type: "text",
        required: true,
        options: [
          { label: "RH", value: "rh" },
          { label: "Autenticacao", value: "autenticacao" },
          { label: "Sessoes", value: "sessoes" },
          { label: "Dispositivos", value: "dispositivos" },
          { label: "Logs", value: "logs" },
          { label: "Segredos tecnicos", value: "segredos_tecnicos" },
          { label: "Parceiros", value: "parceiros" },
          { label: "Contatos", value: "contatos" },
          { label: "Enderecos", value: "enderecos" },
          { label: "Clientes", value: "clientes" },
          { label: "Documentos fiscais", value: "documentos_fiscais" },
          { label: "Catalogo de produtos", value: "catalogo_produtos" },
          { label: "Dados nao pessoais", value: "dados_nao_pessoais" },
        ],
      },
      {
        name: "modulo",
        label: "Modulo",
        type: "text",
        placeholder: "Ex.: rh, fiscal, auth, portal",
      },
      { name: "recurso", label: "Recurso", type: "text" },
      { name: "finalidade", label: "Finalidade", type: "textarea", required: true },
      {
        name: "dadosPessoaisEnvolvidos",
        label: "Dados pessoais envolvidos",
        type: "textarea",
        required: true,
      },
      {
        name: "dadosSensiveis",
        label: "Ha dados sensiveis?",
        type: "text",
        required: true,
        defaultValue: "false",
        options: [
      ...
      { name: "volumeTitulares", label: "Volume de titulares", type: "number" },
      {
        name: "compartilhamentoExterno",
      ...
      {
        name: "medidasTecnicas",
        label: "Medidas tecnicas",
        type: "textarea",
        required: true,
      },
      {
        name: "medidasOrganizacionais",
      ...
      },
      {
        ...
        options: [
          ...
          { label: "Replanejar", value: "replanejar" },
          { label: "Aceito", value: "aceito" },
        ],
      },
      { name: "aprovadoPor", label: "Aprovado por ID", type: "number" },
      { name: "revisadoEm", label: "Revisado em", type: "datetime-local" },
    ],
  },
  "grc.incidentesSeguranca": {
    fields: [
      { name: "codigo", label: "Codigo", type: "text", placeholder: "Opcional, gerado pelo servidor" },
      { name: "titulo", label: "Titulo", type: "text", required: true },
      {
        name: "escopoCritico",
        label: "Escopo critico",
      ...
      {
        name: "resumoIncidente",
        label: "Resumo do incidente",
        type: "textarea",
        required: true,
      },
      { name: "dadosAfetados", label: "Dados afetados", type: "textarea" },
      { name: "titularesEstimados", label: "Titulares estimados", type: "number" },
      {
        name: "segredoTecnicoExposto",
        label: "Segredo tecnico exposto",
        type: "text",
        required: true,
        defaultValue: "false",
        options: [
      ...
      {
        name: "requerComunicacaoAnpd",
        label: "Requer comunicacao ANPD",
        type: "text",
        required: true,
        defaultValue: "false",
        options: [
      ...
      {
        name: "requerComunicacaoTitulares",
        label: "Requer comunicacao aos titulares",
        type: "text",
        required: true,
        defaultValue: "false",
        options: [
      ...
      { name: "dataDeteccao", label: "Data de deteccao", type: "datetime-local", required: true },
      { name: "dataAvaliacao", label: "Data de avaliacao", type: "datetime-local" },
      { name: "dataResposta", label: "Data de resposta", type: "datetime-local" },
      { name: "dataComunicacao", label: "Data de comunicacao", type: "datetime-local" },
      { name: "dataEncerramento", label: "Data de encerramento", type: "datetime-local" },
      { name: "causaRaiz", label: "Causa raiz", type: "textarea" },
      { name: "acoesContencao", label: "Acoes de contencao", type: "textarea" },
      { name: "acoesCorretivas", label: "Acoes corretivas", type: "textarea" },
      { name: "responsavel", label: "Responsavel ID", type: "number" },
    ],
  },
  "grc.governancaPrivacidade": {
    fields: [
      { name: "nomeReferencia", label: "Nome de referencia", type: "text", required: true },
      {
        name: "papelPrivacidade",
        label: "Papel de privacidade",
        type: "text",
        required: true,
        options: [
          { label: "Controlador", value: "controlador" },
          { label: "Operador", value: "operador" },
          { label: "Controlador e operador", value: "controlador_operador" },
        ],
      },
      { name: "encarregadoNome", label: "Nome do encarregado", type: "text", required: true },
      { name: "encarregadoEmail", label: "Email do encarregado", type: "email", required: true },
      {
        name: "encarregadoCanal",
        label: "Canal do encarregado",
        type: "text",
        required: true,
        placeholder: "Ex.: privacidade@tenant.com / portal interno",
      },
      { name: "baseContratual", label: "Base contratual", type: "textarea", required: true },
      { name: "clausulasContratuais", label: "Clausulas contratuais", type: "textarea", required: true },
      {
        name: "suboperadoresDeclarados",
        label: "Suboperadores declarados",
        type: "text",
        required: true,
        defaultValue: "false",
        options: [
      ...
      {
        name: "procedimentoIncidente",
        label: "Procedimento de incidente",
        type: "textarea",
        required: true,
      },
      {
      ...
      { name: "vigenteDesde", label: "Vigente desde", type: "datetime-local" },
      { name: "revisaoProgramadaEm", label: "Revisao programada", type: "datetime-local" },
      { name: "observacoes", label: "Observacoes", type: "textarea" },
    ],
  },
